...
function Game() {
    return (
        <div class="main-container">
            ...
            {deroulement === 'winLoup' && <WinLoup />}
            {joueur.role === 'loup' && <WinVillageois />}
...
function Cupidon() {
  ...
  function Loups() {
    ...
    return (
      <h1>
        Les Loups-Garous se réveillent, se reconnaissent et désignent une
        nouvelle victime !!!
      </h1>
    );
  }
  ...
  function Sorciere() {
    ...
    console.log(
      "La Sorcière se réveille, je lui montre la victime des Loups-Garous. Va-t-elle user de sa potion de guérison, ou d’empoisonnement ?"
    );
    return (
      <h1>
        La Sorcière se réveille, je lui montre la victime des Loups-Garous. Va-t-elle user de sa potion de guérison, ou d’empoisonnement ?
  ...
  function Jour() {
    ...
    return (
      <h1>
        C’est le matin, le village se réveille, tout le monde se réveille et ouvre les yeux…
      </h1>
    );
  }
